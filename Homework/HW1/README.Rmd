...
You are currently in the GitHub repository (repo) for `hw1-username`. The assignment prompt is shown below (i.e. in `README.Rmd`). You can view this online in your homework 1 GitHub repository as a Markdown file(`README.md`) or a pdf.

Please **use `hw1.Rmd` to complete this assignment**. Be sure to **knit your file to PDF before your final push to GitHub**.
